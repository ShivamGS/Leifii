...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] relative py-40 overflow-hidden  antialiased  flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-black rounded-t-3xl"
    >
      <Header />
      <motion.div
        style={{
