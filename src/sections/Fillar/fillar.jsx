    ...
    <div>
      <div className="h-[120vh] md:h-[120vh] w-full bg-white overflow-hidden">
        <div className="h-[65%] w-full flex flex-col md:flex-row">
          ...
          <div className="order-1 md:order-2 w-full lg:w-[30%] h-full mt-[2rem] lg:pt-[0rem] lg:mr-[8rem] flex items-center justify-center">
            <div className="bg-slate-600 h-[18rem] lg:h-[18rem] w-[18rem] lg:w-[30rem] rounded-full overflow-hidden">
              <video
